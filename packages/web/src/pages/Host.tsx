          ...
          {QUIZZES.map((quiz, i) => {
            ...
            return (
              <button
                ...
                className={`group relative animate-rise overflow-hidden rounded-2xl bg-gradient-to-br p-6 text-left shadow-lg ring-1 ring-white/10 transition duration-200 hover:-translate-y-1 ${meta.accent} ${meta.ring} ${meta.span ?? ""}`}
              >
                <span
